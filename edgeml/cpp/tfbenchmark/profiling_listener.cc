...
//  __android_log_print(ANDROID_LOG_ERROR, "tflite", "csv file %s", csv_file_path_.c_str());
...
//    __android_log_print(ANDROID_LOG_ERROR, "tflite", "csv file %s", csv_file_path_.c_str());
  ...
  string summary = run_summarizer_.GetOutputString();
//  __android_log_print(ANDROID_LOG_ERROR, "tflite", "%s", summary.c_str());
...
string ProfilingListener::getSummary(){
    return run_summarizer_.GetOutputString();
}
