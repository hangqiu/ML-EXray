...
class BenchmarkTfLiteModel : public BenchmarkModel {
 public:
  ...
  static BenchmarkParams DefaultParams(string summary_log_file = "");
  BenchmarkTfLiteModel(BenchmarkParams params = DefaultParams());
  ...
  TfLiteStatus InitBenchmarkModel();
  TfLiteStatus InitBenchmarkModel(std::unique_ptr<tflite::Interpreter>* interpreter_ptr);
...
protected:
  ...
  virtual std::unique_ptr<BenchmarkListener> MayCreateProfilingListener(std::unique_ptr<tflite::Interpreter>* interpreter_ptr) const;
