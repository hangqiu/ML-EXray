...
#include "edgeml/cpp/tfbenchmark/benchmark_params.h"
...
class BenchmarkResults {
 public:
  ...
  BenchmarkResults(double model_size_mb, int64_t startup_latency_us,
                   ...
                   edgeml::Stat<int64_t> warmup_time_us,
                   edgeml::Stat<int64_t> inference_time_us,
  ...
  edgeml::Stat<int64_t> inference_time_us() const {
    return inference_time_us_;
  }
  edgeml::Stat<int64_t> warmup_time_us() const { return warmup_time_us_; }
 ...
 private:
  ...
  edgeml::Stat<int64_t> warmup_time_us_;
  edgeml::Stat<int64_t> inference_time_us_;
...
class BenchmarkModel {
 public:
  ...
  BenchmarkModel();
  BenchmarkModel(BenchmarkParams params)
 ...
 protected:
  ...
  virtual edgeml::Stat<int64_t> Run(int min_num_times, float min_secs,
